...
## Usage
From an operating system shell, type <code>python pass-check<code>.</code>py candidate-password</code> where <code>candidate-password</code> is the password to test for exposure in a data breach.
